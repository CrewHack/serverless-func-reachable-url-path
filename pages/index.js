        ...
        <div>
          <>
            <Typography style={{ fontSize: "11px", textAlign: "left" }}>
              ...
              Bitcoin revolutionized "money" forever. Your business will profit
              from the cryptocurrency innovations now becoming more & more
              mainstream by the minute. The time has arrived to get paid in
              Bitcoin in addition to traditional fiat currency variants. Our
              gateway also accepts 150+ traditonal payments methods like debit &
              credit cards & more. The method we'll teach you is <i>by far</i>{" "}
              the quickest & easiest way to start accepting Bitcoin as a payment
              method in the year 2021. You don't have to be a coder to
              implement, anyone can configure the setup quickly. Do-It-Yourself,
              no over-priced consultants. You can get started today. With our
              setup, you don't have to wait on the blockchain to complete
              processing the transactions and receive your crypo payment, nearly
              97% of all transactions are approved almost instantly. We make
              accepting BTC payments just as easy as accepting traditional
              payments like credit and debit cards. Are you accepting Bitcoin
              payments yet? Time to to act <b>now ⏱️ </b>
            </Typography>
          </>
        </div>
      )}
